...
class mainWidget(QWidget):
	def __init__(self, portInstance, parent=None):
		...
		self.tabs.addTab(self.lab1Tabs, "Winch")
		...
		self.lab1Tabs.addTab(guiWidgets.DCMotorControl.DCMotorControl(self.portInstance),
...
class mainInterface(QMainWindow):
	...
	def __init__(self, parent=None):
		...
		self.setWindowTitle("Winch Main Interface")
